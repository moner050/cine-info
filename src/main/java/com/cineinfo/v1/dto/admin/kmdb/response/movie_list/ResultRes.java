...
public class ResultRes {
    ...
    public KMDbMovieInfo toEntity() {
        ...
        return KMDbMovieInfo.builder()
                ...
                .awards1(awards1)
                .awards2(awards2)
                .regDate(regDate.isEmpty() || regDate.length() < 4 ? null : LocalDate.parse(replaceDate(regDate), DateTimeFormatter.ofPattern("yyyyMMdd")))
                .modDate(modDate.isEmpty() || modDate.length() < 4 ? null : LocalDate.parse(replaceDate(modDate), DateTimeFormatter.ofPattern("yyyyMMdd")))
                .build();
    }
